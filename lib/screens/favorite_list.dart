...
class _FavoriteListPageState extends State<FavoriteList> {
  ...
  Widget build(BuildContext context) {
    ...
    final ValueNotifier<List<Map<String, dynamic>>> _postFoodList =
        ValueNotifier<List<Map<String, dynamic>>>([]);
    final ValueNotifier<List<Map<String, dynamic>>> _postLodgeList =
        ValueNotifier<List<Map<String, dynamic>>>([]);
    final ValueNotifier<List<Map<String, dynamic>>> _postPlaceList =
        ValueNotifier<List<Map<String, dynamic>>>([]);

    final foodList = FavoriteListService().getFavoriteFood(user.uid);
    foodList.then((value) {
      _postFoodList.value = value;
    });
    final lodgeList = FavoriteListService().getFavoriteLodge(user.uid);
    lodgeList.then((value) {
      _postLodgeList.value = value;
    });
    final placeList = FavoriteListService().getFavoritePlace(user.uid);
    placeList.then((value) {
      _postPlaceList.value = value;
    });
                  ...
                  child: TabBarView(
                    children: [
                      ValueListenableBuilder(
                          valueListenable: _postFoodList,
                          builder: (BuildContext context,
                              List<Map<String, dynamic>> value, Widget? child) {
                            //favoriteFoodList 확인
                            return (_postFoodList.value.isEmpty)
                                ? Center(
                                    child: Column(
                                      mainAxisAlignment:
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: Container(
                                              ...
                                              child: Text(
                                                '총 ${_postFoodList.value.length}곳',
                                              ...
                                              gridDelegate:
                                                  SliverGridDelegateWithFixedCrossAxisCount(
                                                      ...
                                                      childAspectRatio:
                                                          1 / 1.74),
                                              itemCount:
                                                  _postFoodList.value.length,
                                              itemBuilder: (context, index) {
                                                final doc =
                                                    _postFoodList.value[index];
                      ...
                      ValueListenableBuilder(
                          valueListenable: _postLodgeList,
                          builder: (BuildContext context,
                              List<Map<String, dynamic>> value, Widget? child) {
                            //favoriteLodgeList 확인
                            return (_postLodgeList.value.isEmpty)
                                ? Center(
                                    child: Column(
                                      mainAxisAlignment:
                                          MainAxisAlignment.center,
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: Container(
                                              alignment: Alignment.centerLeft,
                                              child: Text(
                                                '총 ${_postLodgeList.value.length}곳',
                                                textAlign: TextAlign.left,
                                              ),
                                            ),
                                          ),
                                              ...
                                              gridDelegate:
                                                  SliverGridDelegateWithFixedCrossAxisCount(
                                                      ...
                                                      childAspectRatio:
                                                          1 / 1.74),
                                              itemCount:
                                                  _postLodgeList.value.length,
                                              itemBuilder: (context, index) {
                                                final doc =
                                                    _postLodgeList.value[index];
                                                ...
                                                String lodgeAddress =
                                                    doc['address'];
                                                String lodgeArea = doc['area'];
                                                String lodgeBusinessHours =
                                                    doc['businessHours'];
                                                String lodgeIdx = doc['idx'];
                                                String lodgeName = doc['name'];
                                                ...
                                                String lodgeToiletYn =
                                                    doc['toiletYn'];
                                                String lodgeUrl1 = doc['url1'];
                                                String lodgeUrl2 = doc['url2'];
                      ...
                      ValueListenableBuilder(
                          valueListenable: _postPlaceList,
                          builder: (BuildContext context,
                              List<Map<String, dynamic>> value, Widget? child) {
                            //favoritePlaceList 확인
                            return (_postPlaceList.value.isEmpty)
                                ? Center(
                                    child: Column(
                                      mainAxisAlignment:
                                          MainAxisAlignment.center,
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: Container(
                                              alignment: Alignment.centerLeft,
                                              child: Text(
                                                '총 ${_postPlaceList.value.length}곳',
                                                textAlign: TextAlign.left,
                                              ),
                                            ),
                                          ),
                                              ...
                                              gridDelegate:
                                                  SliverGridDelegateWithFixedCrossAxisCount(
                                                      ...
                                                      childAspectRatio:
                                                          1 / 1.74),
                                              itemCount:
                                                  _postPlaceList.value.length,
                                              itemBuilder: (context, index) {
                                                final doc =
                                                    _postPlaceList.value[index];

                                                //Place data 호출
                                                String placeAddress =
                                                    doc['address'];
                                                String placeArea = doc['area'];
                                                ...
                                                String placeName = doc['name'];
                                                String placeNaverLink =
                                                    doc['naverlink'];
                                                String placeNote = doc['note'];
                                                ...
                                                String placeSubtitle =
                                                    doc['subTitle'];
                                                String placeUrl1 = doc['url1'];
                                                String placeUrl2 = doc['url2'];
